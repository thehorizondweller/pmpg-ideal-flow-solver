...
function domainGrids = flowDomainBuild_KTMap(radialPts, angularPts, terminalR, r, A, B, zetaPrimeOffset, zetaPrime1, zetaPrime2, z1, z2, beta)%, offset)
    ...
    % Build the Z domain
    Z = inverseKTMap(ZETA_PRIME, zetaPrime1, zetaPrime2, z1, z2, beta);
